  ...
  return (
      <div className="description">
        ...
        <div className="description-main">
          ...
          <div className="links">
            <Car id="cars" title="Samochody" content="Poznaj naszą flotę" destination="/cars" height="350px" width="700px" contentHeight="25%"/>
            <Car id="about" title="O nas" content="Dowiedz się więcej na temat naszej działalności!" destination="/about" height="350px" width="700px" contentHeight="25%"/>
          </div>
        </div>
      </div>
  );
